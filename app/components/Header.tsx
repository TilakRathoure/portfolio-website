...
const Header = () => {
  return (
    <div>
      {/* <div id="home" className=" w-full h-[15vh]"></div> */}
      <div id="home" className="z-20 flex justify-center gap-3 py-6 items-center mt-[15vh]">
        <div className="max-w-[525px]">
          <p className="text-2xl sm:text-3xl font-light text-nowrap">Hi, I&apos;m Tilak Rathoure</p>
        ...
        <Image src={image1} alt="" className="rounded-full w-[120px] sm:max-h-[140px] sm:min-w-[140px] sm:w-[140px]" />
      </div>
